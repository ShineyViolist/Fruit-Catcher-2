class Form{
    ...
    display() {
        ...
        fill("white");
        this.player1Label.html("Player 1 :" + player.score);
        this.player1Label.position(270, 80);

        this.player2Label.html("Player 2 :" + player.score);
        this.player2Label.position(270, 100);
